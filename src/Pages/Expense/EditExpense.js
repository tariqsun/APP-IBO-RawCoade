...
import { createExpense, getExpense, getExpenseById, getExpenseCategory, updateExpense } from '../../Services/ExpenseService';
...
function EditExpense() {
  ...
  useEffect(()=>{
    ...
    .then((res)=>{
      setState({
        ...state,
        category:res.data.expens.category_id,
        amount:res.data.expens.amount,
        expens_date:res.data.expens.expens_date
      });
    }).catch((err)=>{
