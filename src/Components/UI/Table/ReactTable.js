...
export function BolStatusPill({ value }) {
  const status = value;
    ...
    <span
      className={
        classNames(
          ...
          !status? "bg-red-100 text-red-800" : null,
        )
      }
    >
      {status?'Activate':'Disactive'}
    </span>
  );
};
...
export function PaymentDayStatusPill({ value }) {
  ...
  return (
    <span
      className={
        classNames(
          "px-3 py-1 uppercase leading-wide font-bold text-xs rounded-full shadow-sm",
          status > 15 ? "bg-green-100 text-green-800" : null,
          status <= 15 ? "bg-yellow-100 text-yellow-800" : null,
          status <= 5 ? "bg-red-100 text-red-800" : null,
        )
      }
    >
      {status}
          ...
          <div>
            <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
              ...
              >
                ...
                <FaAngleLeft className="h-5 w-5 text-gray-400" aria-hidden="true" />
              </PageButton>
              <PageButton
                onClick={() => nextPage()}
                ...
                <FaAngleRight className="h-5 w-5 text-gray-400" aria-hidden="true" />
              </PageButton>
              <PageButton
